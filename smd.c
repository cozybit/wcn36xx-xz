...
static int wcn36xx_smd_add_ba_session_rsp(void *buf, size_t len, u8 *session_id)
{
...
int wcn36xx_smd_del_ba(struct wcn36xx *wcn, u16 tid, u8 sta_index, u8 direction)
{
...
int wcn36xx_smd_trigger_ba(struct wcn36xx *wcn, u8 sta_index, u8 session_id)
{
